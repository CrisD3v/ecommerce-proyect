  ...
  return (
    <div className="container mx-auto">
      <div className="w-[70rem] ">
        <h2 className="text-2xl text-center ml-10 font-semibold mb-4">
          ADMINISTRAR CATEGORIAS
        </h2>
        {/* Aquí va el formulario para subir, editar y eliminar categorías */}
        <div className="w-full">
          <div className="w-full flex justify-center gap-10 ml-5">
            <button
      ...
      <div className="w-max-[90rem]  flex flex-wrap flex-col h-[48rem] mt-9 overflow-y-auto transition-all ease-in-out duration-300">
